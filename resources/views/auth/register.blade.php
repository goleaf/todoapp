...
<div class="space-y-6">
    ...
    <x-form.index.input.form method="post" :action="route('register')" class="space-y-6">
        <!-- Name -->
        <div>
            <x-form.index.input.label for="name">{{ __('Your Name') }}</x-input.label>
            <x-form.index.input.input type="text" name="name" id="name" class="mt-1" placeholder="John Doe" required="" :value="old('name')" autofocus autocomplete="name" />
            <x-form.index.input.input-error :messages="$errors->get('name')" class="mt-2" />
        </div>

        <!-- Email Address -->
        <div class="mt-4">
            <x-form.index.input.label for="email">{{ __('Your email') }}</x-input.label>
            <x-form.index.input.input type="email" name="email" id="email" class="mt-1" placeholder="name@company.com" required="" :value="old('email')" autocomplete="username" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-form.index.input.label for="password_confirmation">{{ __('Confirm Password') }}</x-input.label>
