...
>
    ...
    <button
        ...
        aria-expanded="false"
        aria-haspopup="true"
        aria-label="{{ __('accessibility.accessibility_options') }}"
    >
        <span class="sr-only">{{ __('accessibility.accessibility_options') }}</span>
    ...
    >
        <p class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 pb-1 border-b border-gray-200 dark:border-gray-700">
            {{ __('accessibility.accessibility_options') }}
        </p>
        
        <!-- Text Size Controls -->
        <div class="py-1 mb-2">
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400 mb-1">{{ __('accessibility.text_size') }}</p>
            <div class="flex justify-between gap-1">
                ...
                >
                    {{ __('accessibility.text_size_small') }}
                </button>
                <button
                    type="button"
                ...
                >
                    {{ __('accessibility.text_size_medium') }}
                </button>
                <button
                    type="button"
                ...
                >
                    {{ __('accessibility.text_size_large') }}
                </button>
            </div>
        </div>
        ...
        <div class="py-1 mb-2">
            ...
            >
                ...
                {{ __('accessibility.high_contrast_mode') }}
        ...
        <div class="py-1 mb-2">
            ...
            >
                ...
                {{ __('accessibility.reduced_motion') }}
        ...
        <div class="py-1 mb-2">
            ...
            >
                ...
                {{ __('accessibility.enhanced_focus') }}
        ...
        <div class="py-1 pt-2 border-t border-gray-200 dark:border-gray-700">
            ...
            >
                ...
                {{ __('accessibility.accessibility_settings') }}
            </a>
        </div>
    </div>
