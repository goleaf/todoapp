...
class FindUnmigratedComponents extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:find-unmigrated-components';
     ...
     * @var string
     */
    protected $description = 'Find unmigrated components in blade files';
    ...
    public function handle()
    {
        ...
        if (empty($unmigrated)) {
            $this->info('All components migrated successfully!');
            return Command::SUCCESS;
        } else {
            $this->error('Unmigrated components found:');
            foreach ($unmigrated as $issue) {
                $this->line($issue);
            }
    ...
    /**
     * Find unmigrated components recursively.
     */
